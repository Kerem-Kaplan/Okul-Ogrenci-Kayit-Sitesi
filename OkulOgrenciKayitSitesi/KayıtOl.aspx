<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KayıtOl.aspx.cs" Inherits="OkulOgrenciKayitSitesi.KayıtOl" %>
...
<head>
    <title>Okul Ogrenci Kayıt Sitesi</title>
    <!-- Meta tag Keywords -->
        ...
        <div class="container py-xl-5 py-lg-3">
            ...
            <div class="modal-body mt-md-2 mt-5">
                ...
                <form action="#" method="post" runat="server">
                    ...
                    <asp:Button ID="Button1" runat="server" Text="Kayıt Ol" CssClass="btn button-style-w3" OnClick="Button1_Click" />
                </form>
            </div>
            <!-- //register -->
        </div>
